define(['Q', 'underscore', 'mifosX'], function (Q) {
    var components = {
        ...
        controllers: [
            ...
            'accounting/budget/BudgetActionsController',
            'accounting/budget/BudgetoryPositionsController',
            'accounting/budget/BudgetsController',
            'accounting/budget/CreateBudgetController',
            'accounting/budget/CreateBudgetoryPositionController',
            'accounting/budget/CreateItemForBudgetController',
            'accounting/budget/EditBudgetController',
            'accounting/budget/EditBudgetoryPositionController',
            'accounting/budget/EditItemController',
            'accounting/budget/ViewBudgetController',
            'accounting/budget/ViewBudgetoryPositionController',
            'accounting/budget/ViewItemController',
            'accounting/budget/ViewItemsForBudgetController',
